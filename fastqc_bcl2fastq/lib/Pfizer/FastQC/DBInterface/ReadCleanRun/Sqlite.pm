package Pfizer::FastQC::DBInterface::ReadCleanRun::Sqlite;
use base qw( Pfizer::FastQC::DBInterface::ReadCleanRun);

=head1 NAME

Pfizer::FastQC::DBInterface::ReadCleanRun::Sqlite

=head1 SYNOPSIS

=head1 DESCRIPTION

A database interface to enable persistent storage of ReadCleanRun objects using Sqlite.
...
=head2 insert
 ...
 Function: Inserts the ReadCleanRun to the database
 Returns : Nothing
