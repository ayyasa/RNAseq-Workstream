package Pfizer::FastQC::DBInterface::BCLDirectory::Sqlite;
use base qw( Pfizer::FastQC::DBInterface::BCLDirectory);

=head1 NAME

Pfizer::FastQC::DBInterface::BCLDirectory::Sqlite

=head1 SYNOPSIS

=head1 DESCRIPTION

A database interface to enable persistent storage of BCLDirectory objects using Sqlite.
...
=head2 insert
 ...
 Function: Inserts the BCLDirectory to the database
 Returns : Nothing
