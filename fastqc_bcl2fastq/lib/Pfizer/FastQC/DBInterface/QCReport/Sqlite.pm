package Pfizer::FastQC::DBInterface::QCReport::Sqlite;
use base qw( Pfizer::FastQC::DBInterface::QCReport);

=head1 NAME

Pfizer::FastQC::DBInterface::QCReport::Sqlite

=head1 SYNOPSIS

=head1 DESCRIPTION

A database interface to enable persistent storage of QCReport objects using Sqlite.
...
=head2 insert
 ...
 Function: Inserts the QCReport to the database
 Returns : Nothing
