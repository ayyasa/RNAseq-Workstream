package Pfizer::FastQC::Metadata;

=head1 NAME

Pfizer::FastQC::Metadata

=head1 SYNOPSIS

    use Pfizer::FastQC::Metadata;
    my $md = new Pfizer::FastQC::Metadata();

=head1 DESCRIPTION

A Metadata generated after running BCL2FASTQ.
...
=head2 new
 ...
 Title   : new
 Usage   : $md = new Pfizer::FastQC::Metadata(); 
 Function: Returns a bare-bones metadata object
...
sub new {
	...
	confess "you must specify a Metadata.txt file";
    }
