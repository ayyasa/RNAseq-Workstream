package Pfizer::FastQC::DBInterface::RawFastqFile::Sqlite;
use base qw( Pfizer::FastQC::DBInterface::RawFastqFile);

=head1 NAME

Pfizer::FastQC::DBInterface::RawFastqFile::Sqlite

=head1 SYNOPSIS

=head1 DESCRIPTION

A database interface to enable persistent storage of RawFastqFile objects using Sqlite.
...
=head2 insert
 ...
 Function: Inserts the RawFastqFile to the database
 Returns : Nothing
