package Pfizer::FastQC::DBInterface::CleanFastqFile::Sqlite;
use base qw( Pfizer::FastQC::DBInterface::CleanFastqFile);

=head1 NAME

Pfizer::FastQC::DBInterface::CleanFastqFile::Sqlite

=head1 SYNOPSIS

=head1 DESCRIPTION

A database interface to enable persistent storage of CleanFastqFile objects using Sqlite.
...
=head2 insert
 ...
 Function: Inserts the CleanFastqFile to the database
 Returns : Nothing
