package Pfizer::FastQC::DBInterface::Sample::Sqlite;
use base qw( Pfizer::FastQC::DBInterface::Sample);

=head1 NAME

Pfizer::FastQC::DBInterface::Sample::Sqlite

=head1 SYNOPSIS

=head1 DESCRIPTION

A database interface to enable persistent storage of Sample objects using Sqlite.
...
=head2 insert
 ...
 Function: Inserts the Sample to the database
 Returns : Nothing
