package Pfizer::FastQC::DBInterface::SampleGroup::Sqlite;
use base qw( Pfizer::FastQC::DBInterface::SampleGroup);

=head1 NAME

Pfizer::FastQC::DBInterface::SampleGroup::Sqlite

=head1 SYNOPSIS

=head1 DESCRIPTION

A database interface to enable persistent storage of SampleGroup objects using Sqlite.
...
=head2 insert
 ...
 Function: Inserts the SampleGroup to the database
 Returns : Nothing
