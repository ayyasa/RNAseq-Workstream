package Pfizer::FastQC::DBInterface::SampleAttrib::Sqlite;
use base qw( Pfizer::FastQC::DBInterface::SampleAttrib);

=head1 NAME

Pfizer::FastQC::DBInterface::SampleAttrib::Sqlite

=head1 SYNOPSIS

=head1 DESCRIPTION

A database interface to enable persistent storage of SampleAttrib objects using Sqlite.
...
=head2 insert
 ...
 Title   : insert
 Usage   : $dbi->insert($lcms);
 Function: Inserts the SampleAttrib to the database
 Returns : Nothing
