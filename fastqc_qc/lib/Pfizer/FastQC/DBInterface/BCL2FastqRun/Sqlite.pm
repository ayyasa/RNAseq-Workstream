package Pfizer::FastQC::DBInterface::BCL2FastqRun::Sqlite;
use base qw( Pfizer::FastQC::DBInterface::BCL2FastqRun);

=head1 NAME

Pfizer::FastQC::DBInterface::BCL2FastqRun::Sqlite

=head1 SYNOPSIS

=head1 DESCRIPTION

A database interface to enable persistent storage of BCL2FastqRun objects using Sqlite.
...
=head2 insert
 ...
 Function: Inserts the BCL2FastqRun to the database
 Returns : Nothing
