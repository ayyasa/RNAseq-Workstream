...
my $indir = "/hpc/grid/scratch/tbi/fastqc/raw/150420_NS500482_0019_AH04K2AFXX";
# "/hpc/grid/wip_cmg_prec_med/Nucleic_Acid_Group/MiSeq_TREX_2H_fastq files";
my @infastqs = bsd_glob("$indir/*.fastq.gz");
# print(join("\n", @infastqs), "\n");

my $sg = new Pfizer::FastQC::SampleGroup();
unless ($sg->register(undef, 'nextseq_test_3', $Pfizer::FastQC::Config::ADMIN_EMAIL,
	      undef, 'None', 2)) {
